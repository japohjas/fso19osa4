...
describe('favorite blog', () => {
  test('when list has six blogs find the favourite blog', () => {
...
describe('most blogs', () => {
  test('when list has six blogs find the author with most blogs', () => {
...
describe('most likes', () => {
  test('when list has six blogs find the author with most likes', () => {
